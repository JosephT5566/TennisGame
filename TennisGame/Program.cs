...
namespace TennisGame
{
    ...
    public class Scoreboard
    {
        ...
        public Scoreboard()
        {
            ...
            termMap.Add("03", "Love Forty");
            termMap.Add("10", "Fifteen Love");
            termMap.Add("11", "Fifteen All");
            termMap.Add("12", "Fifteen Thirty");
            termMap.Add("13", "Fifteen Forty");
            termMap.Add("20", "Thirty Love");
            termMap.Add("21", "Thirty Fifteen");
            termMap.Add("22", "Thirty Thirty");
            termMap.Add("23", "Thirty Forty");
            termMap.Add("30", "Forty Love");
            termMap.Add("31", "Forty Fifteen");
            termMap.Add("32", "Forty Thirty");
